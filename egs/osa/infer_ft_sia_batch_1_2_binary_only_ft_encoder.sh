...
for ckpt_dir in  v0-20250705-113819  v1-20250705-114612  v2-20250705-115409  v3-20250705-120240  v4-20250705-121046 ; do
    ...
    for i in 8 16 24 32 40 48 56 64 72 80; do
        swift infer \
            --model Qwen/Qwen2.5-Omni-7B \
            --ckpt_dir "./output_sia_batch_1_2_binary_only_ft_encoder/${ckpt_dir}/checkpoint-${i}/" \
